...
**** Your call: Bundle, slice, or other split?
...
**** ACK to defer the version sweep, OR push back if you want it done now.
...
**** ACK on launch-only as default cadence?
...
**** Reserve `Ctrl+Shift+D` for braille toggle per the verbosity-architecture doc?
