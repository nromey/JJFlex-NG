...
- **Tone level** is in dBFS, from minus 40 up to 0. The default of minus 10 lands in the "just right" range on the mic audio verdict. Turn it down to rehearse the "turn it up" warning, or up to hear "coming in hot" — the tone is also how you learn what the coaching sounds like.
