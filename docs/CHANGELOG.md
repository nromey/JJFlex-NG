...
- **The report now points at your radio's manufacturer, not at Flex by name.** The sentence beside the Copy button says the email-ready report goes to your radio's manufacturer, and the try-it-in-the-manufacturer's-own-software advice names SmartSDR as the Flex example instead of assuming everyone owns it. Today every radio JJ Flexible speaks to is a Flex, so nothing changes for you — this is the wording getting honest ahead of the day it wouldn't have been.
...
- **Reconnecting quickly got much less haunted.** Disconnect and reconnect in short order and you could meet a ghost of your own last session still holding your station name — at which point JJ Flexible politely renamed you to get out of your own way, and the connect hung. It no longer mistakes stale leftovers for a real second operator, it now says a proper goodbye to the radio when you disconnect so less gets left behind, and when a radio does refuse to take your station name, the trace finally records the radio's answer instead of shrugging.
...
The reason is a genuinely obscure difference between screen readers: some of them don't pass a held key through to the application at all. They send a rapid series of separate presses and releases instead, and from where JJ Flexible sits that looks exactly like somebody tapping the key over and over. So it unkeyed, because you appeared to have let go.
