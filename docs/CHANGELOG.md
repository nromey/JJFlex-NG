...
- **Warnings do not dip your radio audio any more, unless you decide you want them to.** There is a setting that pulls band audio through your computer down a few decibels while a warning sound plays, so the alert lands on top of the band instead of inside it. It shipped switched on. I have been living with it, and the dip turned out to draw more attention to itself than the warning it was making room for — a rare movement in your audio is more noticeable than a constant one, it turns out. So it starts off now. It is still there, and if you work a genuinely noisy band or a warning has ever slipped straight past you, it is worth a try: **Settings, Notifications tab, under Warnings and Radio Audio**, where there is a switch and a depth from a nudge to a proper hole. And if you were already using it and liked it, nothing changes for you — your setting is your setting, and this does not reach back and undo it.

- **The dip has a pace now, not just a depth.** When I said the dip was distracting, what I actually went looking for was a hang time, and there was not one — the timing was welded shut and only the depth could move. If you switch the dip on, there are now three ways it can move: **Quick**, which is how it shipped, snapping down and back with the sound; **Gentle**, which eases down and eases back; and **Lingering**, which stays down a moment after the warning and comes back slowly, so the band breathes instead of stepping. My hunch is that a dip you notice more than the warning is one that moves too fast rather than one that goes too deep, and now that is something you and I can both test by ear instead of arguing about. On every setting a deeper dip comes back more slowly than a shallow one, so the return never lurches, and nothing ever takes more than a second and a half to bring the band all the way home. Same place as the switch: **Settings, Notifications tab, under Warnings and Radio Audio**.
...
- **[Warnings duck under the band now — and you hold the fader](#warning-dip).** When a warning sounds, radio audio through your computer dips a few decibels so the alert lands on top of the band instead of inside it, then comes right back. There's a switch to turn it off entirely and a depth setting from barely-there to emphatic, because it's your band and your call — especially if you operate remote, where PC audio is the only audio you've got.
...
### Warnings duck under the band now — and you hold the fader {#warning-dip}
