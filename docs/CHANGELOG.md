...
- **The receive check tells you whether audio is actually arriving now.** Everything it used to report was a setting — this output is muted, that level is at 60, radio audio through your computer is on. All true, all worth knowing, and every bit of it something *we* set. None of it could tell you whether a single scrap of sound had ever made it from the radio to your computer, which is the first thing Flex would ask about. So the check now watches what the radio is actually sending and reports what it saw: “Audio arriving from the radio: up to 42 kilobits per second, in 10 of 10 readings taken about a second apart.” If nothing is arriving while radio audio through your computer is switched on, it says so — and tells you whether anything *else* is arriving either, because “the radio is sending its meters but no sound” and “nothing at all is reaching this computer” are two completely different problems with two completely different fixes. And if you listen on the radio’s own speaker, where no sound is meant to come across the network at all, it says none is expected instead of crying wolf at the most ordinary setup there is. Don asked for this one.
