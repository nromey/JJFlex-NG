...
- **A little sound that says help lives here.** Land on a control, rest there a moment, and two quick rising taps mean Ctrl+F1 has something to say. It's polite about it: move quickly and you never hear it, and it only sounds when the help is different from the last help it told you about — five controls sharing one explanation get one tap pair, not five. It has its own switch under Alert Sounds in Settings, and you can audition it in the Earcon Explorer like every other sound.
