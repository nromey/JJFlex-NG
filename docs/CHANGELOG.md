...
- **A little sound that says help lives here.** Land on a control, rest there a couple of seconds, and you get a quick low flick and a soft note an octave above it, fading away — that means Ctrl+F1 has something to say. It's polite about it: move quickly and you never hear it, and it only sounds when the help is different from the last help it told you about — five controls sharing one explanation get one flick, not five. It's the quietest sound in the app on purpose, because it's an offer, not an event, and it deliberately sounds nothing like a toggle. (Ask me how I know. The first version I built was a pair of even beeps in the same voice as the on/off tones, and the first time I heard it in real use I thought I'd bumped a setting.) It has its own switch under Alert Sounds in Settings, and you can audition it in the Earcon Explorer like every other sound.
