...
public static class KeyInventory
{
    ...
    private static readonly FixedKeyEntry[] AudioLayerCommands =
    {
        ...
        new(AudioLayerContext, "Audio layer", "O", "PC output volume in dB — how loud radio audio plays through this computer; Up and Down adjust",
        ...
        new(AudioLayerContext, "Audio layer", "Ctrl+P", "Turn PC audio on or off — whether radio audio plays through this computer at all; O sets how loud",
